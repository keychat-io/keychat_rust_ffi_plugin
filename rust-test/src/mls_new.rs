...
fn test_basic() -> Result<()> {
    ...
    let mut b_mls_group = bob_join_mls_group(welcome.1, &b_provider, group_create_config.clone())?;
    ...
    let mut c_mls_group = bob_join_mls_group(welcome2.1, &c_provider, group_create_config.clone())?;
    // A commit
