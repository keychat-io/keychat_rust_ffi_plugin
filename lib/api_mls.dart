...
Future<MessageInType> parseMlsMsgType({required List<int> data}) =>
    RustLib.instance.api.crateApiMlsParseMlsMsgType(data: data);
...
Future<CommitTypeResult> othersCommitNormal(
