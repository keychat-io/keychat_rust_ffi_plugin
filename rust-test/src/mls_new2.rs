...
fn test_complex() -> Result<()> {
    ...
    // B decrypt A's msg
    let text = decrypt_msg(b.to_string(), group_id.to_string(), msg.clone())?;
    println!("A send msg to B ,the result is {:?}", text);
    // F decrypt A's msg
    let text = decrypt_msg(f.to_string(), group_id.to_string(), msg.clone())?;
    println!("A send msg to F ,the result is {:?}", text);
    ...
    // A decrypt F's msg
    let text2_1 = decrypt_msg(a.to_string(), group_id.to_string(), msg2_1)?;
    ...
    // A decrypt B's msg
    let text3 = decrypt_msg(a.to_string(), group_id.to_string(), msg3.clone())?;
    println!("B send msg to A ,the result is {:?}", text3);
    // C decrypt B's msg
    let text3 = decrypt_msg(c.to_string(), group_id.to_string(), msg3.clone())?;
    println!("B send msg to C ,the result is {:?}", text3);
    // F decrypt B's msg
    let text3 = decrypt_msg(f.to_string(), group_id.to_string(), msg3.clone())?;
    println!("B send msg to F ,the result is {:?}", text3);
    // G decrypt B's msg
    let text3 = decrypt_msg(g.to_string(), group_id.to_string(), msg3.clone())?;
    ...
    // B decrypt A's msg
    let text4 = decrypt_msg(b.to_string(), group_id.to_string(), msg4.clone())?;
    println!("A send msg to B ,the result is {:?}", text4);
    // C decrypt A's msg
    let text4 = decrypt_msg(c.to_string(), group_id.to_string(), msg4.clone())?;
    println!("A send msg to C ,the result is {:?}", text4);
    // D decrypt B's msg
    let text4 = decrypt_msg(d.to_string(), group_id.to_string(), msg4.clone())?;
    println!("A send msg to D ,the result is {:?}", text4);
    // F decrypt B's msg
    let text4 = decrypt_msg(f.to_string(), group_id.to_string(), msg4.clone())?;
    println!("A send msg to F ,the result is {:?}", text4);
    // G decrypt B's msg
    let text4 = decrypt_msg(g.to_string(), group_id.to_string(), msg4.clone())?;
    ...
    // D decrypt A's msg
    let text5 = decrypt_msg(d.to_string(), group_id.to_string(), msg5.clone())?;
    println!("A send msg to D, the result is {:?}", text5);
    // E decrypt A's msg
    let text5 = decrypt_msg(e.to_string(), group_id.to_string(), msg5.clone())?;
    println!("A send msg to E, the result is {:?}", text5);
    // F decrypt A's msg
    let text5 = decrypt_msg(f.to_string(), group_id.to_string(), msg5.clone())?;
    println!("A send msg to F, the result is {:?}", text5);
    // G decrypt A's msg
    let text5 = decrypt_msg(g.to_string(), group_id.to_string(), msg5.clone())?;
    ...
    // D decrypt G's msg
    let text6 = decrypt_msg(d.to_string(), group_id.to_string(), msg6.clone())?;
    println!("G send msg to D, the result is {:?}", text6);
    // E decrypt G's msg
    let text6 = decrypt_msg(e.to_string(), group_id.to_string(), msg6.clone())?;
    println!("G send msg to E, the result is {:?}", text6);
     // F decrypt G's msg
     let text6 = decrypt_msg(f.to_string(), group_id.to_string(), msg6.clone())?;
     println!("G send msg to F, the result is {:?}", text6);
    // A decrypt G's msg
    let text6 = decrypt_msg(a.to_string(), group_id.to_string(), msg6.clone())?;
