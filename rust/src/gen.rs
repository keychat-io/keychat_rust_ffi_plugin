...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1243090249;
...
fn wire__crate__api_mls__delete_key_packages_by_timestamp_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "delete_key_packages_by_timestamp",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| {
                transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || {
                        let output_ok = crate::api_mls::delete_key_packages_by_timestamp(
                            api_nostr_id,
                            api_timestamp,
                        )?;
                        Ok(output_ok)
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        30 => wire__crate__api_mls__delete_key_packages_by_timestamp_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        31 => wire__crate__api_signal__delete_session_impl(port, ptr, rust_vec_len, data_len),
        32 => wire__crate__api_signal__delete_session_by_device_id_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        34 => wire__crate__api_nostr__encrypt_impl(port, ptr, rust_vec_len, data_len),
        35 => wire__crate__api_nostr__encrypt_nip44_impl(port, ptr, rust_vec_len, data_len),
        36 => wire__crate__api_signal__encrypt_signal_impl(port, ptr, rust_vec_len, data_len),
        37 => wire__crate__api_nostr__generate_curve25519_keypair_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        39 => wire__crate__api_nostr__generate_message_key_hash_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        40 => wire__crate__api_signal__generate_prekey_api_impl(port, ptr, rust_vec_len, data_len),
        41 => wire__crate__api_nostr__generate_secp256k1_impl(port, ptr, rust_vec_len, data_len),
        42 => {
            wire__crate__api_nostr__generate_seed_from_key_impl(port, ptr, rust_vec_len, data_len)
        }
        43 => wire__crate__api_nostr__generate_seed_from_ratchetkey_pair_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        44 => wire__crate__api_signal__generate_signal_ids_impl(port, ptr, rust_vec_len, data_len),
        45 => {
            wire__crate__api_signal__generate_signed_key_api_impl(port, ptr, rust_vec_len, data_len)
        }
        46 => wire__crate__api_nostr__generate_simple_impl(port, ptr, rust_vec_len, data_len),
        47 => wire__crate__api_signal__get_all_alice_addrs_impl(port, ptr, rust_vec_len, data_len),
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        33 => wire__crate__api_nostr__encode_bech32_impl(ptr, rust_vec_len, data_len),
