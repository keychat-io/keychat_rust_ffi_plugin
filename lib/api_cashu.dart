...
// These functions are ignored (category: IgnoreBecauseExplicitAttribute): `__send`, `get_mnemonic_info`, `get_wallet`, `lock`, `prepare_one_proofs`
...
Future<List<Transaction>>  receiveTokens({required List<String> encodedTokens }) => RustLib.instance.api.crateApiCashuReceiveTokens(encodedTokens: encodedTokens);
