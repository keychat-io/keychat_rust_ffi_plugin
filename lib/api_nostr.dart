...
Future<String> nip47EncodeUri({required String pubkey, required String relay, required String secret, String? lud16}) =>
    RustLib.instance.api.crateApiNostrNip47EncodeUri(pubkey: pubkey, relay: relay, secret: secret, lud16: lud16);
...
Future<String> sha256HashBytes({required List<int> data}) =>
    RustLib.instance.api.crateApiNostrSha256HashBytes(data: data);
