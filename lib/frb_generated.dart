...
import 'package:flutter_rust_bridge/flutter_rust_bridge_for_generated.dart';
                ...
                class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
                  ...
                  @override
                  int get rustContentHash => -1037191698;
...
Future<KeyPackageResult> crateApiMlsCreateKeyPackageWithLifetime({required String nostrId });
...
@override Future<KeyPackageResult> crateApiMlsCreateKeyPackageWithLifetime({required String nostrId })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
        ...
        ,
            constMeta: kCrateApiMlsCreateKeyPackageWithLifetimeConstMeta,
            argValues: [nostrId],
            apiImpl: this,
        )); }


        TaskConstMeta get kCrateApiMlsCreateKeyPackageWithLifetimeConstMeta => const TaskConstMeta(
            debugName: "create_key_package_with_lifetime",
            argNames: ["nostrId"],
        );
...
@override Future<PreKeyResult> crateApiSignalGeneratePreKeyApi({required KeychatIdentityKeyPair keyPair })  { return handler.executeNormal(NormalTask(
        ...
        TaskConstMeta get kCrateApiSignalGeneratePreKeyApiConstMeta => const TaskConstMeta(
            debugName: "generate_pre_key_api",
            argNames: ["keyPair"],
        );
