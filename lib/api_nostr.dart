...
Future<String> sha256Hash({required String data}) =>
    RustLib.instance.api.crateApiNostrSha256Hash(data: data);

Future<String> sha256HashBytes({required List<int> data}) =>
    RustLib.instance.api.crateApiNostrSha256HashBytes(data: data);

Future<String> sha1Hash({required String data}) =>
    RustLib.instance.api.crateApiNostrSha1Hash(data: data);
