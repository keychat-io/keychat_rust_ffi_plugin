...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -945452816;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        61 => wire__crate__api_signal__get_session_impl(port, ptr, rust_vec_len, data_len),
        62 => wire__crate__api_signal__init_impl(port, ptr, rust_vec_len, data_len),
        63 => wire__crate__api_signal__init_keypair_impl(port, ptr, rust_vec_len, data_len),
        64 => wire__crate__api_signal__init_signal_db_impl(port, ptr, rust_vec_len, data_len),
        65 => wire__crate__api_signal__parse_identity_from_prekey_signal_message_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        66 => wire__crate__api_signal__process_prekey_bundle_api_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        67 => wire__crate__api_signal__session_contain_alice_addr_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        68 => wire__crate__api_signal__update_alice_addr_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
