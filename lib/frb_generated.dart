...
import 'package:flutter_rust_bridge/flutter_rust_bridge_for_generated.dart';
                ...
                class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
                  ...
                  @override
                  int get rustContentHash => -1243090249;
...
Future<void> crateApiMlsDeleteKeyPackagesByTimestamp({required String nostrId , required BigInt timestamp });
...
@override Future<void> crateApiMlsDeleteKeyPackagesByTimestamp({required String nostrId , required BigInt timestamp })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
...
sse_encode_u_64(timestamp, serializer);
        ...
        ,
            constMeta: kCrateApiMlsDeleteKeyPackagesByTimestampConstMeta,
            argValues: [nostrId, timestamp],
            apiImpl: this,
        )); }


        TaskConstMeta get kCrateApiMlsDeleteKeyPackagesByTimestampConstMeta => const TaskConstMeta(
            debugName: "delete_key_packages_by_timestamp",
            argNames: ["nostrId", "timestamp"],
        );
