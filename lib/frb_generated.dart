...
import 'package:flutter_rust_bridge/flutter_rust_bridge_for_generated.dart';
                ...
                class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
                  ...
                  @override
                  int get rustContentHash => 1838185975;
...
Future<String> crateApiNostrGetUnencryptEvent({required String senderKeys , required String receiverPubkey , required String content , String? reply });
...
Future<List<Transaction>> crateApiCashuReceiveTokens({required List<String> encodedTokens });
...
@override Future<String> crateApiNostrGetUnencryptEvent({required String senderKeys , required String receiverPubkey , required String content , String? reply })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
...
@override Future<List<Transaction>> crateApiCashuReceiveTokens({required List<String> encodedTokens })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
              
            final serializer = SseSerializer(generalizedFrbRustBinding);sse_encode_list_String(encodedTokens, serializer);
...
@override Future<String> crateApiNostrSetMetadata({required String senderKeys , required String content })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
...
@override Future<String> crateApiNostrSignSchnorr({required String senderKeys , required String content })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
