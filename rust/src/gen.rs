...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -75426593;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        65 => wire__crate__api_signal__get_identity_impl(port, ptr, rust_vec_len, data_len),
        66 => wire__crate__api_signal__get_session_impl(port, ptr, rust_vec_len, data_len),
        67 => wire__crate__api_signal__init_impl(port, ptr, rust_vec_len, data_len),
        68 => wire__crate__api_signal__init_keypair_impl(port, ptr, rust_vec_len, data_len),
        69 => wire__crate__api_signal__init_signal_db_impl(port, ptr, rust_vec_len, data_len),
        70 => wire__crate__api_signal__parse_identity_from_prekey_signal_message_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        71 => wire__crate__api_signal__process_prekey_bundle_api_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        72 => wire__crate__api_signal__session_contain_alice_addr_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        73 => wire__crate__api_signal__update_alice_addr_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
